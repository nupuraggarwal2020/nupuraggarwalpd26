...
function CaseCard({ cs, index }: { cs: CaseStudy; index: number }) {
  return (
    ...
    >
      ...
      >
        <div className="grid grid-cols-1 px-6 pb-5 pt-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-center md:gap-x-4 md:px-9 md:pb-6 md:pt-9">
          ...
          <h2 className="display mt-2 font-bold text-[clamp(1.6rem,2.6vw,2.5rem)] md:col-span-2 md:mt-3 lg:whitespace-nowrap">
            {cs.heading}
          </h2>
          <p className="mt-3 max-w-2xl text-base font-medium leading-relaxed text-night-ink/85 md:col-span-2 md:text-lg">
            {cs.subheading}
          </p>
          <span className="btn-chip group mt-4 inline-flex w-full items-center justify-center px-5 py-3.5 leading-none md:col-start-2 md:row-start-1 md:mt-0 md:w-auto md:shrink-0">
            View case study
